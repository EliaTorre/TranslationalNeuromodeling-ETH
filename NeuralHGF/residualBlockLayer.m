classdef residualBlockLayer < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods
        function layer = residualBlockLayer(kernel1, kernel2,numFilters,NameValueArgs)
            ...
            layers = [
                convolution2dLayer([kernel1, kernel2],numFilters,Padding="same",Stride=stride)
                %groupNormalizationLayer("all-channels")
                reluLayer
                convolution2dLayer([kernel1, kernel2],numFilters,Padding="same")
            ...
            if includeSkipConvolution
                layers = [
                    convolution2dLayer(1,numFilters,Stride=stride,Name="gnSkip")
